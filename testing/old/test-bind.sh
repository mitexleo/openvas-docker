...
docker run  -d --rm -e SKIPSYNC=true -v $BNDDIR:/data --name $OLDTAG-bnd -p 8081:9392 mitexleo/openvas:$OLDTAG
...
docker run -d -v $BNDDIR:/data -p 9001:9392 --name oldbnd-$tag -e SKIPSYNC=true mitexleo/openvas:$tag
