...
docker run -d -v $OLDVOL:/data -p 9001:9392 --name oldvol-$tag -e SKIPSYNC=true mitexleo/openvas:$tag
docker run -d -v $OLDBIND:/data -p 9002:9392 --name oldbind-$tag -e SKIPSYNC=true mitexleo/openvas:$tag
